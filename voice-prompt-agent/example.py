...
def generate():
    ...
    generate_content_config = types.GenerateContentConfig(
        ...
        response_schema=genai.types.Schema(
            ...
            required = ["Optimised Prompt", "LLM Guidance", "Optimisation Notes"],
            properties = {
                "Optimised Prompt": genai.types.Schema(
                    type = genai.types.Type.STRING,
                ),
                "LLM Guidance": genai.types.Schema(
                    type = genai.types.Type.STRING,
                ),
                "Optimisation Notes": genai.types.Schema(
                    type = genai.types.Type.STRING,
                ),
            },
        ),
